 ...
 <html>  
      ...
      <body style="background-color: #6e7f80;">  
           ...
           <div class="container" style="width:700px; height: 200px">  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="wow.php?action=add&id=<?php echo $row["id"]; ?>">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               ...
                               <input type="submit" name="add_to_cart" style="margin-top:5px; color: black" class="btn btn-warning" value="Add to Cart" />  
                          </div>  
                     </form>  
                </div>  
                <?php  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td><a href="wow.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                          </tr>  
                          <?php  
